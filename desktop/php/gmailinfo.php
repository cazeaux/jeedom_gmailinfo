    ...
    <div class="col-lg-2">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                ...
                <?php
                foreach (eqLogic::byType('gmailinfo') as $eqLogic) {
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{Nom de l'équipement GMail}}</label>
                    <div class="col-lg-3">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">{{Compte GMail}}</label>
                    <div class="col-md-3">
